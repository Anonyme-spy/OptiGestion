# src/modules/analysis_module.py
# NOTE:
# ca: chiffre d'affaire
# nq: nouvelle quantite
# cm: costing module
...
class AnalysisModule:
    ...
    def simulation(self, nouvelle_quantite):
        nq = CostingModule(
            self.costing_module.cf,
            self.costing_module.cv,
            self.costing_module.pv,
            nouvelle_quantite,
        )
        return nq.to_dict()
    ...
    def conseil_automatique(self):
        ...
        elif self.marge_securite() < self.seuil_rentabilite() * 0.2:
